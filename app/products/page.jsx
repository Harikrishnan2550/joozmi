        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-semibold tracking-tight text-emerald-500">
              Where Quality Meets Flavour Precision
            </h2>

            <p className="mt-6 text-base sm:text-lg leading-relaxed text-black/65">
              Joozmi fruit pulp by Gusto is crafted to deliver consistent
              flavour, smooth texture, and reliable quality for beverages,
              desserts, and culinary applications. Sourced from carefully
              selected fruits and processed under controlled standards, Joozmi
              pulps are designed to retain authentic taste, colour, and body.
              With a focus on quality handling and dependable supply, Gusto
              ensures each pack supports professional kitchens, beverage
              creators, and food businesses in creating flavourful experiences
              with ease.
            </p>
