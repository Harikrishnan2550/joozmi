  ...
  function ProductSection({ product, index, totalProducts }) {
    ...
    return (
      <section
        ref={sectionRef}
        className="relative min-h-[0svh] lg:min-h-[75svh]
  flex items-start lg:items-center snap-start lg:snap-center"
      >
        <BackgroundText
          text={product.name}
        ...
        <div className="relative z-10 mx-auto max-w-7xl w-full px-6 lg:px-8 ">
          ...
          >
            {/* LEFT TEXT */}
            <div className="lg:col-span-6 text-center lg:text-left lg:pl-28  ">
              ...
              <motion.h3
                ...
                className="text-[45px] sm:text-6xl lg:text-7xl tracking-tight leading-[1.02] mt-7 lg:mt-10"
  ...
  export default function ProductStory({ products }) {
    ...
    return (
      <main ref={containerRef} className="relative snap-y snap-mandatory pt-36 lg:pt-28">
